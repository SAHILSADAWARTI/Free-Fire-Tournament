...
export default function Leaderboard() {
  ...
  return (
  <main
  className="min-h-screen text-white px-4 md:px-6 py-10"
  style={{
      ...
      <table className="w-full text-center border border-gray-700">
        ...
        <thead className="bg-red-600">
          <tr>
            ...
            <th className="p-2 md:p-3 text-xs md:text-base">M1</th>
            <th className="p-2 md:p-3 text-xs md:text-base">M2</th>
            <th className="p-2 md:p-3 text-xs md:text-base">M3</th>
